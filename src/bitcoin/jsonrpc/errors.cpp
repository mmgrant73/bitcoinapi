...
namespace jsonrpc
{
    ...
    const int Errors::BITCOIN_ERROR_1 =   -1;
    const int Errors::BITCOIN_ERROR_3 =   -3;
    const int Errors::BITCOIN_ERROR_4 =   -4;
    const int Errors::BITCOIN_ERROR_6 =   -6;
	...
	possibleErrors[BITCOIN_ERROR_1] = "Value is type string, expected real";
	possibleErrors[BITCOIN_ERROR_3] = "Invalid amount";
	possibleErrors[BITCOIN_ERROR_4] = "Insufficient funds";
	possibleErrors[BITCOIN_ERROR_6] = "Account has insufficient funds";
    }
